 ...
 */
export default function CardActions({ sighting }: { sighting: Sighting }) {
  ...
  return (
    <div className="card-actions">
      <div className="row-actions">
        <Button variant="primary" icon="download" onClick={() => run('image')} disabled={busy !== null}>{busy === 'image' ? '만드는 중…' : '이미지 저장'}</Button>
