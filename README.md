...
| 새 카드 — 사용자의 Card Reveal 디자인(어두운 숲, 등급색, No.·별), 네 박자 등장 연출, 기울기·빛, **이미지(PNG)·영상(MP4/WebM) 저장** | 동작. 단, 디자인 원본의 카드 본체 파일이 없어서 카드 안의 배치는 단서로 다시 짠 것이다 (`cardLook.ts` 머리말) |
...
**당장 할 작업 넷**(손실 막기 → 카드 등급 제거 → 초안 보존·다시 판정 → 타임라인 위치)과 저장 방식 결정은 [`WORK_ORDERS.md`](WORK_ORDERS.md) — 한 번에 하나씩, "작업 N"으로 부른다.
