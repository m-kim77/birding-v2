...
export const THEMES: ThemeDef[] = [
  {
    ...
    tokens: {
      ...
      // 종이 결 — 아주 옅은 가로줄
      backdrop: 'repeating-linear-gradient(0deg, transparent 0 27px, rgba(160,120,40,0.045) 27px 28px)',
      cardBlur: 'none',
    },
  },
  {
    ...
    tokens: {
      ...
      radiusCard: '6px', radiusControl: '6px',
      fontDisplay: SERIF, fontBody: SANS, weightTitle: '700',
      tabBg: 'rgba(23,21,15,0.97)', tabActive: '#A9C47F', tabInactive: '#B0A37E',
      ok: '#A9D98A', warn: '#F0B66E', err: '#FF9B8F',
      backdrop: 'repeating-linear-gradient(0deg, transparent 0 27px, rgba(216,200,144,0.035) 27px 28px)',
      cardBlur: 'none',
    },
  },
  {
...
export const THEME_CHOICES: ThemeChoice[] = [
  { id: 'dogam', name: '도감', desc: '자연 도감 · 기기가 다크면 밤 모드', light: 'dogam', dark: 'dogam-night' },
